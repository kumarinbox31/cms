...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>grapes/stylesheets/toastr.min.css">
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>grapes/stylesheets/grapes.min44a5.css?v0.20.4">
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>grapes/stylesheets/grapesjs-preset-webpage.min.css">
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>grapes/stylesheets/tooltip.css">
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>grapes/stylesheets/demos43a0.css?v3">
    <link href="https://unpkg.com/grapick%400.1.13/dist/grapick.min.css" rel="stylesheet">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script src="<?php echo base_url('public/admin/'); ?>grapes/js/toastr.min.js"></script>
    <script src="<?php echo base_url('public/admin/'); ?>grapes/js/grapes.min44a5.js?v0.20.4"></script>
    ...
    <!--plugins-->
    <!--<script src="<?php echo base_url('public/admin/'); ?>grapes/js/grapesjs-swiper-slider.min.js"></script>-->
    ...
    <style type="text/css">
        ...
        .icon-dir-row {
          background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-dir-row.png") no-repeat center;
        }
        .icon-dir-row-rev {
          background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-dir-row-rev.png") no-repeat center;
        }
        .icon-dir-col {
          background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-dir-col.png") no-repeat center;
        }
        .icon-dir-col-rev {
          background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-dir-col-rev.png") no-repeat center;
        }
        .icon-just-start{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-just-start.png") no-repeat center;
        }
        .icon-just-end{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-just-end.png") no-repeat center;
        }
        .icon-just-sp-bet{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-just-sp-bet.png") no-repeat center;
        }
        .icon-just-sp-ar{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-just-sp-ar.png") no-repeat center;
        }
        .icon-just-sp-cent{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-just-sp-cent.png") no-repeat center;
        }
        .icon-al-start{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-al-start.png") no-repeat center;
        }
        .icon-al-end{
        ...
        .icon-al-center{
         background: url("<?php echo base_url('public/admin/'); ?>grapes/img/flex-al-center.png") no-repeat center;
        }
  ...
  <body>
    ...
    editor.on('load', function() {
        ...
        addContentBeforeBodyClosingTag(`<?php echo json_encode($beforeend); ?>`);
