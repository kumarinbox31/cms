...
<div class="alert alert-danger">
    <h1 class="text-center"><img src="https://icons8.com/preloaders/preloaders/788/WhatsApp%20logo%20animated.gif"> Welcome to AB WHATSAPP ICONS</h1>
</div>
<?php 
...
<div class="card">
    <form method="POST" action="">
        ...
        <div class="card-header bg-primary text-white d-block">
            Config Setting 
                <button type="submit" class="btn btn-sm btn-<?=$btn_color?> pull-right"><i class="fa fa-toggle-<?=$btn_icon?>"></i></<button>
        </div>
    </form>
    <div class="card-body">
        <form method="POST" action="" class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" min="0" class="form-control" name="ab-whatsapp-number" value="<?=getVal('ab-whatsapp-number');?>" placeholder="Enter whatsapp number">
            </div>
            <div class="form-group col-md-6">
