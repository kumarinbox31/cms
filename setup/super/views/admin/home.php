                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-info" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                                    </div>
                                </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: <?php  echo $activePer; ?>%;"></div>
                                    </div>
                                </div>
                                </a>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $inactivePer; ?>%;"></div>
                                    </div>
                                </div>
                                </a>
                            </div>
